...
export type PaymentMethodsQuery = { paymentMethods: (
...
export namespace PaymentMethods {
  export type Variables = PaymentMethodsQueryVariables;
  export type Query = PaymentMethodsQuery;
  export type PaymentMethods = (NonNullable<PaymentMethodsQuery['paymentMethods']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<PaymentMethodsQuery['paymentMethods']>)['items']>)[number]>;
}
